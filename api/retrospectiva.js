...
Superfície: ${match.surface}${match.location ? " | Local: " + match.location : ""}`.trim();
  ...
  const instructions = {
    win_continue: `Escreva uma retrospectiva curta e animada dessa vitória (3 parágrafos). Tom: emotivo e esportivo, como se fosse escrito por um pai ou mãe orgulhoso. Celebre os destaques técnicos (aces, winners), mencione algum momento dramático se o placar indicar jogo disputado. Termine com entusiasmo para a próxima rodada. IMPORTANTE: evite referências a público, arquibancada, aplausos ou torcida presente — a família acompanhou pelo celular.`,
    loss_eliminated: `Escreva uma retrospectiva positiva e inspiradora do torneio inteiro de ${athleteName} (4-5 parágrafos). Tom: encorajador e realista — como um pai ou mãe que quer mostrar ao filho que o esforço valeu. A derrota é só um detalhe, o foco são os pontos altos. Destaque aces, winners, rodadas vencidas. Termine com orgulho e motivação. IMPORTANTE: evite referências a público, arquibancada, aplausos ou torcida presente.`,
    final_win: `Escreva uma retrospectiva emocionante da conquista do campeonato por ${athleteName} (4-5 parágrafos). Tom: glorioso mas íntimo — como uma mensagem da família para a atleta. Comece com a vitória na final, depois percorra os melhores momentos do torneio com dados concretos. Termine com mensagem tocante para a família. IMPORTANTE: evite referências a público, arquibancada, aplausos ou torcida presente — use apenas dados reais da partida.`,
    final_loss: `Escreva uma retrospectiva calorosa da campanha de ${athleteName} até a final (4-5 parágrafos). Tom: orgulho genuíno e realista — chegar à final já é conquista enorme. Comece reconhecendo o esforço da final, depois celebre o caminho com dados concretos. Termine com mensagem emocionante de motivação. IMPORTANTE: evite referências a público, arquibancada, aplausos ou torcida presente.`,
  };
